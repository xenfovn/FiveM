...
Radio.Labels = {        
	{ "FRZL_RADIO_HELP", "~s~" .. (radioConfig.Controls.Secondary.Enabled and "~" .. radioConfig.Controls.Secondary.Name .. "~ + ~" .. radioConfig.Controls.Activator.Name .. "~" or "~" .. radioConfig.Controls.Activator.Name .. "~") .. " to hide.~n~~" .. radioConfig.Controls.Toggle.Name .. "~ Cai Dat Radio ~g~on~s~.~n~~" .. radioConfig.Controls.Decrease.Name .. "~ or ~" .. radioConfig.Controls.Increase.Name .. "~ de chuyen doi Tan so~n~~" .. radioConfig.Controls.Input.Name .. "~ Chon Tan So~n~~" .. radioConfig.Controls.ToggleClicks.Name .. "~ De ~a~ On/Off Voice s~n~Tan So: ~1~ MHz" },
	{ "FRZL_RADIO_HELP2", "~s~" .. (radioConfig.Controls.Secondary.Enabled and "~" .. radioConfig.Controls.Secondary.Name .. "~ + ~" .. radioConfig.Controls.Activator.Name .. "~" or "~" .. radioConfig.Controls.Activator.Name .. "~") .. " to hide.~n~~" .. radioConfig.Controls.Toggle.Name .. "~ Cai Dat Radio ~r~off~s~.~n~~" .. radioConfig.Controls.Broadcast.Name .. "~ De phat song..~n~Tan So: ~1~ MHz" },
	{ "FRZL_RADIO_INPUT", "Nhap Tan So" },
}
