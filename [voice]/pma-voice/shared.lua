...
if GetConvar('voice_useNativeAudio', 'false') == 'true' then
	...
	Cfg.voiceModes = {
		{1.0, "Thì Thầm"}, -- Whisper speech distance in gta distance units
		{2.3, "Bình Thường"}, -- Normal speech distance in gta distance units
		{5.0, "La Hét"} -- Shout speech distance in gta distance units
	}
else
	Cfg.voiceModes = {
		{3.0, "Thì Thầm"}, -- Whisper speech distance in gta distance units
		{7.0, "Bình Thường"}, -- Normal speech distance in gta distance units
