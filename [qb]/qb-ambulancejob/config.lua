...
Config.Locations = {
    ...
    ["helicopter"] = {
        [1] = {x = 350.38, y = -587.81, z = 74.16, h = 67.95},
...
Config.BleedingStates = {
    [1] = {label = 'bị đau nhẹ..', damage = 10, chance = 50},
    [2] = {label = 'bị đau..', damage = 15, chance = 65},
    [3] = {label = 'bị gãy chân..', damage = 20, chance = 65},
    [4] = {label = 'chấn thương sọ não..', damage = 25, chance = 75},
}
