...
Config.Locations = {
   ["duty"] = {
       [1] = {x = 440.44, y = -975.72, z = 30.69, h = 12.74},
      -- [2] = {x = -449.811, y = 6012.909, z = 31.815, h = 90.654},
   },    
   ["vehicle"] = {
       [1] = {x = 453.14, y = -1017.55, z = 28.46, h = 89.8},
      -- [2] = {x = 471.13, y = -1024.05, z = 28.17, h = 274.5},
      -- [3] = {x = -455.39, y = 6002.02, z = 31.34, h = 87.93},
   },    
   ["stash"] = {
       [1] = {x = 455.87, y = -979.03, z = 30.69, h = 56.83},
     --  [2] = {x = -434.63, y = 6001.63, z = 31.71, h = 316.5, r = 1.0}, 
   },     
   ["impound"] = {
       [1] = {x = 440.22, y = -1026.43, z = 28.76, h = 92.51},
    --   [2] = {x = -436.14, y = 5982.63, z = 31.34, h = 136.0, r = 1.0},
   }, 
   ["helicopter"] = {
       [1] = {x = 450.01, y = -981.2, z = 43.69, h = 127.77},
    --   [2] = {x = -475.43, y = 5988.353, z = 31.716, h = 31.34},
   }, 
   ["armory"] = {
       [1] = {x = 458.01, y = -979.09, z = 30.69, h = 358.09},
      -- [2] = {x = -436.82, y = 5996.98, z = 31.716, h = 90.654},
   },   
   ["trash"] = {
       [1] = {x = 460.0, y = -979.03, z = 30.69, h = 354.23},
   },      
   ["fingerprint"] = {
       [1] = {x = 447.45, y = -975.79, z = 30.69, h = 6.01},
     --  [2] = {x = -442.38, y = 6011.9, z = 27.98, h = 311.5},
   },
   ["evidence"] = {
       [1] = {x = 452.81, y = -973.26, z = 30.69, h = 7.66},
 --     [2] = {x = -439.09, y = 6003.12, z = 31.84, h = 90.654},
  ...
  --     [2] = {x = -439.54, y = 6011.42, z = 27.98, h = 44.5, r = 1.0},
   ...
   ["evidence3"] = {
       [1] = {x = 0, y = 0, z = 0, h = 272.5},
    ---   [2] = {x = -439.43, y = 6009.45, z = 27.98, h = 134.5, r = 1.0},
   },        
   ["stations"] = {
       [1] = {label = "Trụ Sở Cảnh Sát", coords = {x = 428.23, y = -984.28, z = 29.76, h = 3.5}},
       [2] = {label = "Nhà Tù", coords = {x = 1845.903, y = 2585.873, z = 45.672, h = 272.249}},
     --  [3] = {label = "Trụ Sở Cảnh Sát Paleto", coords = {x = -451.55, y = 6014.25, z = 31.716, h = 223.81}},
   },
}
