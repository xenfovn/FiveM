...
GangGarages = {
    ["ballasgarage"] = {
        label = "Ballas",
        takeVehicle = {x = 98.50, y = -1954.49, z = 20.84},
        spawnPoint = {x = 98.50, y = -1954.49, z = 20.75, h = 335.73},
        putVehicle = {x = 94.75, y = -1959.93, z = 20.84},
        isHouse = false,
    },
    ["la_familiagarage"] = {
        label = "La Familia",
        takeVehicle = {x = -811.65, y = 187.49, z = 72.48},
        spawnPoint = {x = -818.43, y = 184.97, z = 72.28, h = 107.85},
        putVehicle = {x = -811.65, y = 187.49, z = 72.48},
        isHouse = false,
    },
    ["nomadsgarage"] = {
        label = "Lost MC",
        takeVehicle = {x = 957.25, y = -129.63, z = 74.39},
        spawnPoint = {x = 957.25, y = -129.63, z = 74.39, h = 199.21},
        putVehicle = {x = 950.47, y = -122.05, z = 74.36},
        isHouse = false,
    },
    ["cartelgarage"] = {
        label = "Cartel",
        takeVehicle = {x = 1407.18, y = 1118.04, z = 114.84},
        spawnPoint = {x = 1407.18, y = 1118.04, z = 114.84, h = 88.34},
        putVehicle = {x = 1407.18, y = 1118.04, z = 114.84},
        isHouse = false,
    },
}
