...
Citizen.CreateThread(function()
    ...
    AddTextComponentSubstringPlayerName("Tòa Thị Chính")
    ...
    while true do
        ...
        if dist < 20 then
            ...
            if #(pos - vector3(Config.Cityhall.coords.x, Config.Cityhall.coords.y, Config.Cityhall.coords.z)) < 1.5 then
                qbCityhall.DrawText3Ds(Config.Cityhall.coords, '~g~E~w~ - Truy Cập')
...
AddEventHandler('qb-cityhall:client:sendDriverEmail', function(charinfo)
    SetTimeout(math.random(2500, 4000), function()
        ...
        TriggerServerEvent('qb-phone:server:sendNewMail', {
            ...
            message = "Xin Chào " .. gender .. " " .. charinfo.lastname .. ",<br /><br />Chúng tôi vừa nhận được một thông điệp rằng ai đó muốn học bài lái xe<br />Nếu bạn sẵn sàng dạy, xin vui lòng liên hệ với chúng tôi:<br />Naam: <strong>".. charinfo.firstname .. " " .. charinfo.lastname .. "</strong><br />Số điện thoại: <strong>"..charinfo.phone.."</strong><br/><br/>Trân trọng,<br />Thị trấn Los Santos.",
            button = {}
        })
    end)
end)
...
RegisterNUICallback('requestId', function(data)
    if inRange then
        ...
        QBCore.Functions.Notify('Bạn đã nhận được '..idTypes[idType].label..' cho $50', 'success', 3500)
    else
        QBCore.Functions.Notify('Điều này sẽ không hoạt động', 'error')
    end
end)
...
RegisterNUICallback('requestLicenses', function(data, cb)
    ...
    for type,_ in pairs(licensesMeta) do
        if licensesMeta[type] then
            ...
            if type == "driver" then licenseType = "driver_license" label = "Cấp phép lái xe" end
