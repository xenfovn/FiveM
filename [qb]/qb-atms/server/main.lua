...
Citizen.CreateThread(function()
    while true do
        Wait(3600000)
        dailyWithdraws = {}
        TriggerClientEvent('QBCore:Notify', -1, "Giới hạn hàng ngày được đặt lại.", "success")
    end
end)
        ...
        if dailyWith < 5000 then
            ...
            if xCH ~= nil then
                ...
                if bankCount > 0 then
                    ...
                    TriggerClientEvent('QBCore:Notify', src, "Rút tiền $" .. data.amount .. ' từ thẻ tín dụng. Rút tiền hàng ngày: ' .. dailyWithdraws[cardHolder], "success")
                else
                    TriggerClientEvent('QBCore:Notify', src, "Bạn không thể nhập điểm trừ trong máy ATM.", "error")
                end
            ...
            TriggerClientEvent('QBCore:Notify', src, "Bạn đã đạt đến giới hạn hàng ngày.", "error")
        end
    end
end)
