...
Config.Strings = {
	ExitVehicle = "Thoát khỏi xe để tiếp nhiên liệu",
	EToRefuel = "nhấn ~g~E ~w~để tiếp nhiên liệu phương tiện",
	JerryCanEmpty = "can xăng trống",
	FullTank = "xe đã đầy",
	PurchaseJerryCan = "nhấn ~g~E ~w~để mua can xăng với giá ~g~$" .. Config.JerryCanCost,
	CancelFuelingPump = "nhấn ~g~E ~w~hủy bỏ nhiên liệu",
	CancelFuelingJerryCan = "nhấn ~g~E ~w~hủy bỏ nhiên liệu",
	NotEnoughCash = "Không đủ tiền mặt",
	RefillJerryCan = "nhấn ~g~E ~w~ để đổ đầy can xăng ",
