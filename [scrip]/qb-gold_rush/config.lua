...
Config.Zones = {
	...
	--[[ VehicleSpawner = {
		...
		Text = 'Nhấn ~b~[E]~w~ để lấy ra 1 chiếc xe',
...
--[[ 	VehicleDeleter = {
	...
	OrchardActions = {
		...
		Size  = {x = 1.0, y = 1.0, z = 1.0},
		Color = {r = 255, g = 255, b = 255},
		Text = 'Nhấn ~b~[E]~s~ để mở văn phòng ông chủ',
		Type  = 27, Rotate = false
	},
	...
	Cloakroom = {
		...
		Size    = {x = 1.0, y = 1.0, z = 1.0},
		Color   = {r = 255, g = 255, b = 255},
		Text = 'Nhấn ~b~[E] ~s~ to open the cloak room',
		Type    = 27, Rotate = false
	},
...
Config.GoldPosition = {
        {coords = vector3(-179.37, 3044.10, 19.29), heading = 282.49}
        
    }

Config.Process = vector3(-168.41, 3036.24, 20.90)
Config.Process1 = vector3(283.45, 2847.50, 43.64)
Config.Process2 = vector3(-661.00, -219.58, 37.73)
Config.Process3 = vector3(-680.25, -172.33, 37.82)
Config.Process4 = vector3(-665.90, -174.61, 37.68)

Strings = {
   
    ['wood_info'] = 'Press ~INPUT_ATTACK~ to chop, ~INPUT_FRONTEND_RRIGHT~ to stop.',
    ['you_sold'] = 'Bạn đã bán %sx %s cho %s',
    ['carpr'] = 'Đào Vàng | Cất Xe',
    ['carpik'] = 'Đào Vàng | Lấy Xe',
    ['selgol'] = 'Đào Vàng | Bán',
    ['processogrezzo'] = 'Đào Vàng | Xử Lý Vàng Thô',
    ['procsabbia'] = 'Đào Vàng | Lọc Sỏi',
    ['raccoltasabbia'] = 'Đào Vàng | Đãi Vàng'
}