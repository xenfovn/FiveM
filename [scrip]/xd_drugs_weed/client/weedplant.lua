	...
	while true do
		...
		if nearbyObject and IsPedOnFoot(playerPed) then
			...
			if IsControlJustReleased(0, 38) and not isPickingUp then
				...
				QBCore.Functions.Progressbar("search_register", "Picking up Cannabis..", 1000, false, true, {
...
function SellDrug()  -- simple animations to loop while process is taking place
	...
	QBCore.Functions.Progressbar("search_register", "Trying to Process..", 1000, false, true, {
		disableMovement = true,
		disableCarMovement = true,
		disableMouse = false,
		disableCombat = true,
